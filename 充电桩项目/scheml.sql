...
CREATE TABLE `answer`  (
  ...
  `answerDescribe` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '答案描述',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
...
CREATE TABLE `bankcard`  (
  ...
  `cardNumber` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '卡号',
  `validityPeriod` date NULL DEFAULT NULL COMMENT '有效期',
  `depositBank` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '开户行',
...
CREATE TABLE `breakdown`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NULL DEFAULT NULL COMMENT '用户id',
  `chargingStation_id` int NULL DEFAULT NULL COMMENT '充电站id',
  `stump_id` int NULL DEFAULT NULL COMMENT '充电桩id',
  `breakTime` datetime NULL DEFAULT NULL COMMENT '故障时间',
  `breakType` int NULL DEFAULT NULL COMMENT '故障类别id',
  `breakDescribe` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '描述',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '维修员id',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

DROP TABLE IF EXISTS `breaktype`;
CREATE TABLE `breaktype`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `breakName` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '故障名称',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `carbrand`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `brandImage` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '品牌图标',
  `brand` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '品牌名',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `carinfo`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `licenceNumber` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '车牌号',
  `mileage` int NULL DEFAULT NULL COMMENT '续航里程',
  `user_id` int NULL DEFAULT NULL COMMENT '用户id',
  `carModel_id` int NULL DEFAULT NULL COMMENT '车辆类型id',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删除',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '车辆品牌Id',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `carmodel`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `modelImage` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '车型图片',
  `carModel` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '车型',
  `carBrandId` int NULL DEFAULT NULL COMMENT '车辆品牌',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `chargingstation`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `stationName` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '充电站名称',
  `stationAddress` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '充电站地址',
  `longitude` double NULL DEFAULT NULL COMMENT '坐标（经度）',
  `latitude` double NULL DEFAULT NULL COMMENT '坐标（纬度）',
  `stationPhoto` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '站点实景图',
  `stumpNum` int NULL DEFAULT NULL COMMENT '充电桩数量',
  `stationIntroduction` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '站点介绍',
  `stop` int NULL DEFAULT NULL COMMENT '停车（0免费，1付费）',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删除',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
DROP TABLE IF EXISTS `chargingstation_opentime`;
CREATE TABLE `chargingstation_opentime`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '中间表编号',
  `chargingStation_id` int NULL DEFAULT NULL COMMENT '充电站id',
  `openTime_id` int NULL DEFAULT NULL COMMENT '开放时间id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

DROP TABLE IF EXISTS `chargingstation_stationservice`;
CREATE TABLE `chargingstation_stationservice`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '编号',
  `chargingStation_id` int NULL DEFAULT NULL COMMENT '充电站外键',
  `stationService_id` int NULL DEFAULT NULL COMMENT '站点服务外键',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

DROP TABLE IF EXISTS `chargingstationservice`;
CREATE TABLE `chargingstationservice`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `chargingstationID` int NULL DEFAULT NULL,
...
CREATE TABLE `collect`  (
  ...
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uniq_user_station`(`user_id` ASC, `chargingStation_id` ASC) USING BTREE,
  INDEX `idx_charging_station`(`chargingStation_id` ASC) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '代码生成业务表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 399 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Dynamic;

DROP TABLE IF EXISTS `opentime`;
CREATE TABLE `opentime`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `openData` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '开放日期',
  `openTimePeriod` varchar(225) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '开放时间',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `order`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `carInfoID` int NULL DEFAULT NULL COMMENT '车辆信息id',
  `maxPower` int NULL DEFAULT NULL COMMENT '最大功率',
  `createTime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `chargingTime` double NULL DEFAULT NULL COMMENT '充电时长',
  `orderPrice` double NULL DEFAULT NULL COMMENT '订单金额',
  `userID` int NULL DEFAULT NULL COMMENT '用户id',
  `payWay` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '支付方式',
  `chargingStationID` int NULL DEFAULT NULL COMMENT '充电站id',
  `stumpID` int NULL DEFAULT NULL COMMENT '充电桩id',
  `state` int NULL DEFAULT NULL COMMENT '状态（未完成0，已完成1，取消2）',
  `cancelCause` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '取消原因',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删除',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `power`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `maxPower` int NULL DEFAULT NULL COMMENT '最大功率',
  `price` double NULL DEFAULT NULL COMMENT '价格/h',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `question`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `questionDescribe` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '问题描述',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `searchrecord`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NULL DEFAULT NULL COMMENT '用户id',
  `searchContent` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '搜索内容',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删除',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_search_content`(`searchContent`(50) ASC) USING BTREE,
  INDEX `idx_user_del`(`user_id` ASC, `del` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

DROP TABLE IF EXISTS `staff`;
CREATE TABLE `staff`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `credentials` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '资格证书',
  ...
  `staffType_id` int NULL DEFAULT NULL COMMENT '员工类别',
  `staffDescribe` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '员工描述',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_phone`(`phone` ASC) USING BTREE,
  INDEX `idx_staffType_id`(`staffType_id` ASC) USING BTREE,
  INDEX `idx_state_del`(`state` ASC, `del` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

DROP TABLE IF EXISTS `stafftype`;
CREATE TABLE `stafftype`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `jobTitle` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '职务名称',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_jobTitle`(`jobTitle` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

DROP TABLE IF EXISTS `stationgrade`;
CREATE TABLE `stationgrade`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `grade` double NULL DEFAULT NULL COMMENT '评分',
  `user_id` int NULL DEFAULT NULL COMMENT '用户id',
  `commentContent` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '评论内容',
...
CREATE TABLE `stationservice`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `serviceType` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '服务类型',
  `chargingStation_id` int NULL DEFAULT NULL COMMENT '充电站id',
...
DROP TABLE IF EXISTS `stump`;
CREATE TABLE `stump`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `stumpName` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '充电桩名称',
  `occupy` int NULL DEFAULT NULL COMMENT '是否被占用（0没占用，1占用）',
  `power_id` int NULL DEFAULT NULL COMMENT '功率id',
  `chargingStation_id` int NULL DEFAULT NULL COMMENT '充电站id',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 130 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '字典数据表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 453 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2293 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1016 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 137 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `topup`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NULL DEFAULT NULL COMMENT '用户id',
  `rechargeMoney` double NULL DEFAULT NULL COMMENT '充值金额',
  `rechargeMode` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '充值方式',
  `rechargeData` datetime NULL DEFAULT NULL COMMENT '充值时间',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删除',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `phoneNum` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '手机号',
  `password` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '密码',
  ...
  `user_id` int NULL DEFAULT NULL COMMENT 'systemUser表外键',
  `money` double NULL DEFAULT 0 COMMENT '钱包金额',
  `del` int NULL DEFAULT 0 COMMENT '逻辑删除0/1',
  `spare1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户昵称',
  `spare2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `usercar`  (
  ...
  `carBrand` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '车辆品牌',
  `carModel` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '车辆型号',
  `mileage` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '车辆续航',
  PRIMARY KEY (`id`) USING BTREE
