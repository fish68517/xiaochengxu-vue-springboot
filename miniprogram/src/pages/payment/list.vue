...
function openBill(id:number){uni.navigateTo({url:`/pages/payment/detail?id=${id}`})}
</script>
...
<template>
  <view class="page payment-page">
    ...
    <view v-for="bill in filtered" :key="bill.id" class="bill card" @click="openBill(bill.id)">
