  ...
  <view class="admin-shell">
    ...
    <view class="sidebar" :class="{ open: mobileOpen }">
      ...
      <view class="account-block">
        ...
        <button class="logout" aria-label="退出登录" @click="logout">退出</button>
      </view>
    </view>
    <view class="workspace">
      <view class="topbar">
        ...
        <view class="top-actions">
          ...
          <view class="user-chip"><view class="avatar small">{{ userInitial }}</view><text>{{ userName }}</text></view>
        </view>
      </view>
...
const visibleGroups = computed(() => {
  ...
  return groups.map((group) => ({ ...group, items: group.items.filter((item) => all || menus.includes(item.key)) })).filter((group) => group.items.length);
});
