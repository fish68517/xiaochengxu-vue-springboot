...
const labels = { PENDING_PAYMENT: '待支付', PENDING_ACCEPT: '待受理', PENDING_GRAB: '待抢单', ASSIGN_PENDING: '待接指派', IN_SERVICE: '服务中', PENDING_CONFIRM: '待验收', SETTLED: '已结单', REFUNDING: '退款中', REFUNDED: '已退款', DISPUTING: '异议中', CANCELLED: '已取消', CLOSED: '已关闭' };
